				...
				$
						.ajax({
							...
							success : function(data) {
								...
								var asset2 = asset1
										+ Number(jsonArr.list[0].asset2);
								var asset3 = asset2
										+ Number(jsonArr.list[0].asset3);
								var asset4 = asset3
										+ Number(jsonArr.list[0].asset4);
								var asset5 = asset4
										+ Number(jsonArr.list[0].asset5);
								var asset6 = asset5
										+ Number(jsonArr.list[0].asset6);
								var asset7 = asset6
										+ Number(jsonArr.list[0].asset7);
								var asset8 = asset7
										+ Number(jsonArr.list[0].asset8);
								var asset9 = asset8
										+ Number(jsonArr.list[0].asset9);
								var asset10 = asset9
										+ Number(jsonArr.list[0].asset10);
								var asset11 = asset10
										+ Number(jsonArr.list[0].asset11);
								var asset12 = asset11
										+ Number(jsonArr.list[0].asset12);

								var ctx = document.getElementById('assetline')
										.getContext("2d");
							...
							<div class="dropdown" id="selcircle">
								...
								<ul class="dropdown-menu" role="menu" aria-labelledby="menu1"
									...
									<li role="presentation"><a role="menuitem" tabindex="-1"
										href="#" onclick="circleAsset(0);">1년전체</a></li>
									<li role="presentation"><a role="menuitem" tabindex="-1"
										href="#" onclick="circleAsset(1);">1월</a></li>
									<li role="presentation"><a role="menuitem" tabindex="-1"
										href="#" onclick="circleAsset(2);">2월</a></li>
									<li role="presentation"><a role="menuitem" tabindex="-1"
										href="#" onclick="circleAsset(3);">3월</a></li>
									<li role="presentation"><a role="menuitem" tabindex="-1"
										href="#" onclick="circleAsset(4);">4월</a></li>
									<li role="presentation"><a role="menuitem" tabindex="-1"
										href="#" onclick="circleAsset(5);">5월</a></li>
									<li role="presentation"><a role="menuitem" tabindex="-1"
										href="#" onclick="circleAsset(6);">6월</a></li>
									<li role="presentation"><a role="menuitem" tabindex="-1"
										href="#" onclick="circleAsset(7);">7월</a></li>
									<li role="presentation"><a role="menuitem" tabindex="-1"
										href="#" onclick="circleAsset(8);">8월</a></li>
									<li role="presentation"><a role="menuitem" tabindex="-1"
										href="#" onclick="circleAsset(9);">9월</a></li>
									<li role="presentation"><a role="menuitem" tabindex="-1"
										href="#" onclick="circleAsset(10);">10월</a></li>
									<li role="presentation"><a role="menuitem" tabindex="-1"
										href="#" onclick="circleAsset(11);">11월</a></li>
									<li role="presentation"><a role="menuitem" tabindex="-1"
										href="#" onclick="circleAsset(12);">12월</a></li>
								</ul>
							</div>
						</div>
					</div>
