			...
			<div class="panel-group" id="accordion">
				...
				<div class="panel panel-default">
					...
					<div id="collapse2" class="panel-collapse collapse">
						<div class="panel-body fontfamily2">이지샵 자동장부는 누구나 쉽게 이용할 수
				...
				<div class="panel panel-default">
					...
					<div id="collapse5" class="panel-collapse collapse">
						<div class="panel-body fontfamily2">매출, 매입에 대한 거래내역을 등록하면
							이지샵 자동장부의 부가가치세신고, 소득세신고에서 신고에 필요한 서류가 자동으로 생성 됩니다. 따라서, 이지샵
							자동장부에서 자동생성 된 신고서를 출력하여 신고를 하거나, 이지샵 자동장부에서 제공하는 전자신고용 파일로 홈택스에서
							전자신고를 하면 됩니다.</div>
					</div>
				</div>
				<div class="panel panel-default">
