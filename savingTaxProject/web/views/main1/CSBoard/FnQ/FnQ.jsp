...
<body>
	...
	<div class="container">
		<center>
			...
			<h3 class="fontfamily">절세미인을 처음 이용하시나요?</h3>
			<h4 class="fontfamily">처음 오신 분들이 궁금해 하는 점을 모아놨습니다.</h4>
		</center>
		...
		<div class="panel-group" id="accordion">
				...
				<div class="panel-heading">
					<h4 class="panel-title">
						<a data-toggle="collapse" data-parent="#accordion"
							href="#collapse1"  class="fontfamily">처음 방문하였습니다. 어떻게 이용할 수 있을까요?</a>
					</h4>
				</div>
				<div id="collapse1" class="panel-collapse collapse in">
					<div class="panel-body fontfamily2">먼저, 무료회원가입 버튼을 클릭하고 회원가입을 합니다. (1개월
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h4 class="panel-title">
						<a data-toggle="collapse" data-parent="#accordion"
							href="#collapse2" class="fontfamily">세무/회계 지식이 거의 없는데 혼자 사용할 수 있나요?</a>
					</h4>
				</div>
				<div id="collapse2" class="panel-collapse collapse">
					<div class="panel-body fontfamily2">이지샵 자동장부는 누구나 쉽게 이용할 수 있도록 개발 되었습니다.
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h4 class="panel-title">
						<a data-toggle="collapse" data-parent="#accordion"
							href="#collapse3"  class="fontfamily">사업으로 인해 시간이 부족한데 작성할 시간이 부족하지 않을까요?</a>
					</h4>
				</div>
				<div id="collapse3" class="panel-collapse collapse">
					<div class="panel-body fontfamily2">장부는 성실하게 작성할 수록 정확하고, 꼼꼼하게 사용할 수
			...
			<div class="panel panel-default">
				...
				<div id="collapse4" class="panel-collapse collapse">
					<div class="panel-body fontfamily2" >수입 - 전자세금계산서,현금영수증,카드매출 에 대하여 수집하여
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h4 class="panel-title">
						<a data-toggle="collapse" data-parent="#accordion"
							href="#collapse5"  class="fontfamily">세무신고 하는게 어려울 것 같은데 하는 방법 좀 설명해 주세요.</a>
					</h4>
				</div>
				<div id="collapse5" class="panel-collapse collapse">
					<div class="panel-body fontfamily2">매출, 매입에 대한 거래내역을 등록하면 이지샵 자동장부의
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h4 class="panel-title">
						<a data-toggle="collapse" data-parent="#accordion"
							href="#collapse6"  class="fontfamily">장부 작성 시 사용한 증빙들을 세무신고 시 세무서에 제출해야 하나요?</a>
					</h4>
				</div>
				<div id="collapse6" class="panel-collapse collapse">
					<div class="panel-body fontfamily2">장부/증빙 등을 세무신고 시 제출하여 신고하는 것은 아닙니다.
			...
			<div class="panel panel-default">
				...
				<div id="collapse7" class="panel-collapse collapse">
					<div class="panel-body fontfamily2">자동장부 이용 서비스에 대한 결제금액 은 다음 과 같습니다. *
			...
			<div class="panel panel-default">
				...
				<div id="collapse8" class="panel-collapse collapse">
					<div class="panel-body fontfamily2">자동장부는 결제 시 기간별로 결제하시는 게 아니라 월 장부 별로
