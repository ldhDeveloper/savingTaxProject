...
<body>
	...
	<div class="middle hidden-xs">
		...
		<div id="clist">
			...
			<label id=ctitlec>&nbsp;&nbsp;
				<input class="redact" value="" name="title" readonly></label>
		</div>
			...
			<table>
				<thead>
					<tr class="thmd">
						<th id="thth">작성일</th>
						<th id="thc">
							<input value="" name="date" readonly>
						</th>
						<th id="thth">작성자</th>
						<th id="thc">
							<input value="" name="writer" readonly>
						</th>
						<th id="thth">조회수</th>
						<th id="thcS">
							<input value="" name="readcount" readonly>
						</th>
					</tr>
				</thead>
				...
				<tbody class="tablemd tbodymd font-family-md-3">
					...
					<tr>
						<td colspan="6" class="tdmd" id="ccontents">
							<h3></h3>
							<textarea class="redact" value="" name="contents" readonly></textarea><br> <br>
		...
		<div align="right">
				...
				<script type="text/javascript">
					function redact(){
						$(".redact").attr("readonly", false);
						$("button").attr("visibility", true); //버튼 감추기
					}
				</script>
