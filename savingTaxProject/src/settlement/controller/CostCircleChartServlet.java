...
/**
 * Servlet implementation class CostCircleChartServlet
 */
@WebServlet("/ccirchart")
public class CostCircleChartServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CostCircleChartServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<AssetCircle> list = new SettleService().costDonut(pno, dyear, cselect);
