...
/**
 * Servlet implementation class AssetCircleChartServlet
 */
@WebServlet("/acircle")
public class AssetCircleChartServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AssetCircleChartServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<AssetCircle> list = new SettleService().assetDonut(pno, dyear, cselect);
