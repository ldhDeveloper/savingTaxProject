...
public Post(int post_no, String post_name, Date post_date, String post_contents, int board_no, int pNo, int post_ref_no,
		int read_count, String fName, String refName) {
	super();
	this.post_no = post_no;
	this.post_name = post_name;
	this.post_date = post_date;
